...
[链接到规范](https://github.com/smart-data-models/dataModel.QueueManagement/blob/master/QueueMonitor/doc/spec_ZH.md)
### Examples
...
Link to the [PostgreSQL schema](https://github.com/smart-data-models/dataModel.QueueManagement/blob/master/QueueMonitor/schema.sql) of this data model
### Contribution
